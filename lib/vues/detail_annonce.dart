        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  widget.annonceRef.name ?? 'Annonce Name',
                ...
                Text(
                  widget.annonceRef.description ?? 'Description',
                  style: const TextStyle(
                    fontSize: 16,
                    letterSpacing: 0,
                    fontWeight: FontWeight.normal,
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Date de debut: ${widget.annonceRef.dateDebut}',
                          style: const TextStyle(
                            fontSize: 16,
                            letterSpacing: 0,
                            fontWeight: FontWeight.normal,
                      ...
                      Expanded(
                        child: Text(
                          'Date de fin : ${widget.annonceRef.dateFin}',
                          style: const TextStyle(
                            fontSize: 16,
                            letterSpacing: 0,
                            fontWeight: FontWeight.normal,
